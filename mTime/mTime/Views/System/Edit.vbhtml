...
@Using (Html.BeginForm("Edit", "System", method:=FormMethod.Post, New With {.enctype = "multipart/form-data"}))
    ...
    @<div Class="stbox_lt_part1">
        ...
        <div Class="lt_pt1_box2">
            ...
            @*<a> @Html.Partial("UploadImg")</a>*@
                ...
                <input id="UploadImg" type="file" name="postedFile" accept=".png" class="fa fa-folder-open pt1_b2_folderbtn filter1" />
