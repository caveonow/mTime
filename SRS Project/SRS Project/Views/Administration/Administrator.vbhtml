...
<div class="body_center">
    ...
    <div class="bd_ctr_rightpart">
        ...
        <div id="addbox-01" class="ctr_rtpt_box display_none">
            <div class="ctr_rtpt_b_ht">
                <span>Administrator - Add Item</span>
            </div>

            <div class="ctr_holiday_addbox">
                <div class="hlday_addbox_part">
                    <div class="hlday_addbox_pt_tt">Administrator :</div>
                ...
                <div class="hlday_addbox_part">
                    <div class="hlday_addbox_pt_tt">Administration type :</div>
                    <input type="text" id="title" name="title">
        ...
        <div id="editbox-01" class="ctr_rtpt_box display_none">
            <div class="ctr_rtpt_b_ht">
                <span>Administrator - Edit</span>
            </div>

            <div class="ctr_holiday_addbox">
                <div class="hlday_addbox_part">
                    <div class="hlday_addbox_pt_tt">Administrator :</div>
                    <input type="text" id="title" name="title" value="Superrior Administrator">
                ...
                <div class="hlday_addbox_part">
                    <div class="hlday_addbox_pt_tt">Administration type :</div>
                    <input type="text" id="title" name="title" value="Master Admin">
